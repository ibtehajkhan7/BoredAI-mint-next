...
async function setupMetaplexDev() {
  ...
  splittedContent[5] = `metaplex create_candy_machine --env mainnet-beta --keypair ~/.config/solana/devnet.json --price ${mintPrice || 1} > ./logs/main/candy-machine-log.txt`

  const startDate = await getStartDate()
  splittedContent[7] = `metaplex update_candy_machine -d "${startDate || '25 Sep 2021 00:00:00'}" --env mainnet-beta --keypair ~/.config/solana/devnet.json > ./logs/main/candy-machine-start-date.txt`
